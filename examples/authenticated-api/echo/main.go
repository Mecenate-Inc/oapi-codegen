...
import (
	...
	"github.com/Mecenate-Inc/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/Mecenate-Inc/oapi-codegen/v2/examples/authenticated-api/echo/server"
