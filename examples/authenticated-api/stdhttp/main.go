...
import (
	...
	"github.com/Mecenate-Inc/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/Mecenate-Inc/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)
