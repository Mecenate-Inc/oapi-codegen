...
import (
	...
	"github.com/Mecenate-Inc/oapi-codegen/v2/pkg/util"
)

const (
	remoteRefFile = `https://raw.githubusercontent.com/deepmap/oapi-codegen/master/examples/petstore-expanded` +
		`/petstore-expanded.yaml`
	remoteRefImport = `github.com/Mecenate-Inc/oapi-codegen/v2/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/Mecenate-Inc/oapi-codegen/v2/examples/petstore-expanded"`)
